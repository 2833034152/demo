...
void LCD_ShowHanzi(u16 x,u16 y,u8 num,u8 size,u8 mode);                      //显示汉字

//char hanZi{ "吗高度"};
void show_chinese(u16 x,u16 y, const char *p,u8 mode);

void showHanzi(u16 x,u16 y,const char *p,u8 mode);  //显示汉字符串
 void showCur(float * curData  ,int counts , float tarHeight)  ;//画曲线
void  drawLine( int x1 ,int y1 , int x2 , int y2);    //任意两点之间画直线
